...
```
CREATE EXTENSION recsys;
```

### Основные архитектурные компоненты:
1. Система хранения моделей
    - Таблица recsys.models с отслеживанием статусов (untrained, training, ready, failed)
    - Синглтон ModelManager для взаимодействия с моделями
    - Модель eSASRec с блоками LiGR для генерации рекомендаций
...
3. Основное API для пользователя
